...
function ItemForm(props) {
    ...
    const addItems = (data) => {
        ...
        const item={
            item:child.item,
            item_title:batches[0].ns_item.title,
            desc:batches[0].ns_item.title,
            batch:child.batch,
    ...
    const handleBatchChange = (event) => {
        ...
        setChild((prevState) => ({
            ...prevState,
            unit_price: value.sale_unit_price
        }));
        setChild((prevState) => ({
            ...prevState,
            discount: value.sale_unit_discount
        }));
    }
    ...
    return (
        <form >
            <Box direction='row' >
                <Stack>
                    <TitleTypograpy sx={{ marginTop: 2, marginBottom: 2 }}>{t('Stock Assigned')}</TitleTypograpy>
                    <Grid container>
                        ...
                        <Grid item xs={3} sx={{ marginRight: 5, marginBottom: 2 }}>
                            <FormControl>
                        ...
                        <Grid item xs={3} sx={{ marginRight: 2 }}>
                            <TextField
                                sx={{
                                    marginLeft: 1, marginTop: 2, backgroundColor: '#fff', "& .MuiInputBase-root": {
                                        height: 40,
                                        backgroundColor: '#fff'
                                    }
                                }}
                                ...
                                helperText={errors.unit_price && errors.unit_price}
                            />
                        </Grid>
                        <Grid item xs={3} sx={{ marginRight: 2 }}>
                            <TextField
