...
function Form(props) {
    ...
    const onSubmit = (data) => {
        if (items.length > 0) {
            ...
            console.log(payload);
            axios.post(apidata.api + 'order/request',
                { data: payload },
        ...
        <Box direction='row'>
            ...
            <Paper elevation={5} sx={{ maxWidth: 900, minHeight: 50, paddingLeft: 3, paddingTop: 0, paddingRight: 2 }}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Stack>
                        <TitleTypograpy sx={{ marginTop: 1, marginBottom: 1, fontSize: 18, variant: 'bold' }}>{t('pinkbug_sales_request_new')}</TitleTypograpy>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={2}>
                                <Button variant="contained" color="primary" onClick={searchCustomer}>
                           ...
                           <Grid item xs={3} sx={{ marginRight: 2, marginTop:1 }}><TextField
                                ...
                                value={child.advance_payment}
                                onChange={handleInputChange}
                                error={errors.advance_payment}
                                helperText={errors.advance_payment && errors.advance_payment}
                            />
                            </Grid>
